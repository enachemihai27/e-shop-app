...
<header>
            ...
            <div class="col-xl-5 col-3 col-md-3 col-lg-6">
                <div class="wsus__call_icon_area">
                    ...
                    <ul class="wsus__icon_area">
                        <li><a href="wishlist.html"><i class="fal fa-heart"></i>{{--<span></span>--}}</a></li>
                        <li><a href="compare.html"><i class="fal fa-random"></i>{{--<span></span>--}}</a></li>
    ...
    <div class="wsus__mini_cart">
        ...
        <ul class="mini_cart_wrapper">
            @foreach(Cart::content() as $sidebarProduct)
                <li id="mini_cart_{{$sidebarProduct->rowId}}">
                    <div class="wsus__cart_img" style="height: 70px; object-fit: cover;">
        ...
        <div class="mini_cart_actions {{Cart::content()->count() == 0 ? 'd-none' : ''}}">
            <h5>sub total <span id="mini_cart_subtotal">{{$settings->currency_icon}}</span></h5>
