    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query){
                ...
                $deleteBtn = "<a href = '".route('admin.shipping-rules.destroy', $query->id)."' class='btn btn-danger ml-2 delete-item'><i class='fas fa-trash-alt'></i></a>";
            ...
            ->addColumn('type', function ($query) {
                switch ($query->type) {
                    ...
                    case 'min_cost' :
                        return "<i class='badge badge-warning'>Min Cost</i>";
                    default :
